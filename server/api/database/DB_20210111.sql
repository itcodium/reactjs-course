CREATE DATABASE  IF NOT EXISTS `u159062377_news` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `u159062377_news`;
-- MySQL dump 10.13  Distrib 8.0.22, for Linux (x86_64)
--
-- Host: 172.23.0.1    Database: u159062377_news
-- ------------------------------------------------------
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduleDelete`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduleGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduleGetById`(pk int)
BEGIN
    select id_modulo,modulo,codigo,vigencia_desde,vigencia_hasta,creado_por,modificado_por
    from hr_app_modulo
    where id_modulo=pk;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduleInsert`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduleUpdate`(
	pId_Modulo int,
	pModulo varchar(100),
    pCodigo varchar(64),
	pVigencia_Desde datetime,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduleDelete`(pk int)
BEGIN
    delete from hr_app_perfil_modulo
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduleGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduleGetById`(pk int)
BEGIN
    select id_perfil_modulo,id_perfil,id_modulo,creado_por,fecha_creacion,modificado_por,fecha_modificacion 
    from hr_app_perfil_modulo
    where id_perfil_modulo=pk;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduleGetByIdPerfil`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduleGetByModuloUsuario`(pModulo varchar(100),pIdUsuario int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduleInsert`(
	pId_Perfil int ,
	pId_Modulo int ,
	pEnabled int,
	pCreado_Por varchar(20)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduleUpdate`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `productGetById`(pk int)
BEGIN
    select a.id_product as id, a.sku, a.name, a.description, b.url as image, a.price, a.created, a.created_by, a.updated, a.updated_by
   from st_product a
   inner join st_product_images b
