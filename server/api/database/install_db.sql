...
--
-- Host: localhost    Database: u477008465_react
-- ------------------------------------------------------
...
--
-- Current Database: `u477008465_react`
-- CREATE DATABASE u477008465_react;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='Tabla de usuarios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hr_menu` VALUES (1,NULL,NULL,1,4),(2,NULL,NULL,2,3),(3,NULL,NULL,119,122),(4,NULL,NULL,120,121),(5,NULL,NULL,117,118),(6,NULL,NULL,5,12),(10,NULL,NULL,10,11),(11,NULL,NULL,8,9),(12,NULL,NULL,115,116),(13,NULL,NULL,93,94),(14,NULL,NULL,95,96),(15,NULL,NULL,97,98),(16,NULL,NULL,99,100),(17,NULL,NULL,101,102),(18,NULL,NULL,103,104),(19,NULL,NULL,105,106),(20,NULL,NULL,107,108),(21,NULL,NULL,109,110),(22,NULL,NULL,111,112),(23,NULL,NULL,113,114),(24,NULL,NULL,91,92),(25,NULL,NULL,89,90),(26,NULL,NULL,77,88),(27,NULL,NULL,84,87),(28,NULL,NULL,85,86),(29,NULL,NULL,80,83),(30,NULL,NULL,81,82),(31,NULL,NULL,78,79),(32,NULL,NULL,61,76),(33,NULL,NULL,70,75),(34,NULL,NULL,62,69),(35,NULL,NULL,67,68),(36,NULL,NULL,73,74),(37,NULL,NULL,65,66),(38,NULL,NULL,71,72),(39,NULL,NULL,63,64),(40,NULL,NULL,47,60),(41,NULL,NULL,54,59),(42,NULL,NULL,48,53),(43,NULL,NULL,49,52),(44,NULL,NULL,57,58),(45,NULL,NULL,55,56),(46,NULL,NULL,50,51),(47,NULL,NULL,43,46),(48,NULL,NULL,44,45),(49,NULL,NULL,19,42),(50,NULL,NULL,36,41),(51,NULL,NULL,26,35),(52,NULL,NULL,20,25),(53,NULL,NULL,39,40),(54,NULL,NULL,29,34),(55,NULL,NULL,23,24),(56,NULL,NULL,21,22),(57,NULL,NULL,27,28),(58,NULL,NULL,37,38),(59,NULL,NULL,32,33),(60,NULL,NULL,30,31),(64,NULL,NULL,17,18),(68,NULL,NULL,6,7),(69,NULL,NULL,13,14),(70,NULL,NULL,15,16);
...
INSERT INTO `hr_menu_text` VALUES (1,1,'Tienda','ES',NULL,'','','',NULL,1),(2,2,'Productos','ES',NULL,'/products','','',NULL,1),(3,3,'User','ES',NULL,'','login','',NULL,1),(4,4,'Logout','ES',NULL,'/Logout','','logout',NULL,1),(5,5,'Contacto','ES',NULL,'/contact','','',1,1),(6,6,'Admin','ES',NULL,'','','',NULL,1),(10,10,'User','ES',NULL,'/user','','',NULL,1),(11,11,'Menu','ES',NULL,'/menu','','',NULL,1),(15,68,'User Privileges','ES',NULL,'/userPrivileges','','',NULL,1),(16,69,'Home','ES',NULL,'/','','',1,0),(17,70,'Login','ES',NULL,'/Login','','',1,1);
...
INSERT INTO `hr_menu_usuario` VALUES (1,1,2,0),(2,2,2,0),(3,5,2,0),(4,4,2,1),(5,3,2,1),(6,17,25,1),(7,16,25,1),(8,3,25,1),(9,4,25,1),(10,6,25,0),(11,6,2,1),(12,7,2,0),(13,8,2,0),(14,1,85,1),(15,2,85,1),(16,3,85,1),(17,4,85,1),(18,5,85,1),(19,9,2,0),(20,10,2,1),(21,11,2,1),(24,68,2,1),(25,6,85,0),(26,68,85,0),(27,11,85,0),(28,10,85,0),(29,9,85,0),(30,7,85,0),(31,8,85,0),(32,2,89,1),(33,1,89,1),(34,3,89,1),(35,4,89,1),(36,1,25,1),(37,2,25,1);
...
--
-- Dumping routines for database 'u477008465_react'
--
...
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` FUNCTION `getErrorMessage`(pLang varchar(2),pValue varchar(5)) RETURNS varchar(1024) CHARSET latin1
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` FUNCTION `getMenuId`(pName varchar(128)) RETURNS int(11)
BEGIN
		DECLARE  vId INT;
        SELECT a.id_menu
			INTO vId 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` FUNCTION `getParamValue`(pParamName varchar(50)) RETURNS varchar(500) CHARSET latin1
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` FUNCTION `raiseError`(pLang varchar(2),pValue varchar(5)) RETURNS varchar(1024) CHARSET latin1
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `getErrorMessage`(pLang varchar(2),pValue varchar(5))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `getSessionKeyByUser`(pEmail varchar(200),pPassword varchar(50),pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `getSessionKeys`()
BEGIN
   	Select 
	  uuid,
	  id_usuario,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `getSessionkeysByUUID`(pUuid varchar(64))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_addNodeChild`(pId_menu int,
pLang varchar(2),
pName varchar(128),
pUrl varchar(255),
pIcon varchar(65),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_addNodeSameLevel`(pId_menu int,
pLang varchar(2),
pName varchar(128),
pUrl varchar(255),
pIcon varchar(64),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_changeUserPrivilege`(pId_menu int,
pId_usuario int,
pValue int
)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_deleteNode`(pId_menu int)
BEGIN
		DECLARE vCount INT;
        DECLARE myLeft INT;
        DECLARE myRight INT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_deleteNodeMoveChild`(pId_menu int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getAll`(pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getAllLeafNodes`(pLang varchar(2))
BEGIN
		SELECT c.menu_text
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getDepthSubTree`(id int,pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getFullTree`(id int,pLang varchar(2))
BEGIN
		SELECT c.menu_text
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getImmediateSubordinatesNode`(id int,pLang varchar(2))
BEGIN
    	SELECT c.menu_text, (COUNT(parent.id_menu) - (sub_tree.depth + 1)) AS depth
		FROM hr_menu AS node,
			hr_menu AS parent,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getNodesDepth`(pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getNodesDepthByUser`(pLang varchar(2),idUser int)
BEGIN
		SELECT  node.lft,node.id_menu ,c.menu_text as title,  c.url,c.icon,c.action, (COUNT(parent.id_menu) - 1) AS depth,
		c.default,
        c.visible,
        ifnull(( select enabled   
				 from hr_menu_usuario  AS mu
					INNER JOIN  hr_menu_text mt
                     ON mu.id_menu =mt.id_menu 
                     AND mt.lang= pLang
				 where mu.id_usuario= idUser and mu.id_menu =node.id_menu ),
                 IF(ISNULL(idUser),c.default,0)  ) as enabled 
		FROM hr_menu AS node,
			 hr_menu AS parent,
             hr_menu_text AS c
		WHERE node.lft BETWEEN parent.lft AND parent.rgt
				AND node.id_menu=c.id_menu   
				AND c.lang= pLang
		GROUP BY node.lft,node.id_menu,c.url,c.icon,c.action,c.menu_text,c.default,c.visible
		ORDER BY node.lft; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getNodesDepthByUserUrl`(pIdUser int ,pUrl varchar(128))
BEGIN
SELECT  node.lft,node.id_menu ,c.menu_text as title,  c.url,c.icon,c.action, (COUNT(parent.id_menu) - 1) AS depth,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_getSinglePath`(id int,pLang varchar(2))
BEGIN
		SELECT c.menu_text 
		FROM hr_menu AS node,hr_menu AS parent,hr_menu_text AS c
		WHERE node.lft BETWEEN parent.lft AND parent.rgt
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_List`(pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `menu_updateNode`(
pId_menu int,
pLang varchar(2),
pName varchar(128),
pUrl varchar(255),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `productGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `productGetById`(pk int)
BEGIN
    select a.id_product as id, a.sku, a.name, a.description, b.url as image, a.price, a.created, a.created_by, a.updated, a.updated_by
   from st_product a
   inner join st_product_images b
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `sessionkeysGetAll`()
BEGIN
    select uuid,id_usuario,expiration,created
    from hr_app_session_keys;
END ;;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `usuarioDelete`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `usuarioGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `usuarioGetById`(pk int)
BEGIN
    select id_usuario,usuario,nombre,apellido,email,password,id_perfil,vigencia_desde,vigencia_hasta,creado_por,fecha_creacion,modificado_por,fecha_modificacion 
    from hr_app_usuario
    where id_usuario=pk;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `usuarioInsert`(
	pUsuario varchar(50),
	pNombre varchar(50),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u477008465_react`@`127.0.0.1` PROCEDURE `usuarioUpdate`(
	pId_Usuario int,
	pNombre varchar(50),
	pApellido varchar(50),
	pVigencia_Desde date,
...
/*!50001 VIEW `test_view` AS select `hr_error`.`id_error` AS `id_error`,`hr_error`.`lang` AS `lang`,`hr_error`.`value` AS `value`,`hr_error`.`message` AS `message`,`hr_error`.`fecha_creacion` AS `fecha_creacion` from `hr_error` */;
...
-- Dump completed on 2021-07-03 21:49:00
